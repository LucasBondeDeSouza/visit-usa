...
const states = [
    {
        name: "Alabama",
        description: "Localizado no coração do sul dos Estados Unidos, o Alabama é um estado rico em história, cultura e belezas naturais. Conhecido por sua participação no movimento pelos direitos civis e por suas paisagens deslumbrantes, oferece uma variedade de atrações para todos os gostos.",
        cards: [
